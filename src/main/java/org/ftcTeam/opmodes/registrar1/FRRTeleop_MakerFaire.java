 ...
 */
@TeleOp
public class FRRTeleop_MakerFaire extends ActiveOpMode {
    ...
    private static double SLOW_DRIVE = 1.0;
    ...
    private final static float OPEN_GRIPPER_SMALL_LEFT = .60f; //.52 too less, .62 too much
    private final static float OPEN_GRIPPER_SMALL_RIGHT = .40f;//.48 too less, .38 too much
...
//        }
        ...
        if (driver.right_bumper) {
            clampLeft.setPosition(CLOSED_GRIPPER_LEFT);
            clampRight.setPosition(CLOSED_GRIPPER_RIGHT);
