...
public class OldAutonomousRelicBlueJewelOnly1 extends ActiveOpMode {
    ...
    public static final double SHOULDER_MOVEMENT_INCREMENT = 0.005;
...
*/
    ...
    private double currentJewelPosition;
    private double desiredJewelShoulderPosition;
    ...
    protected void activeLoop() throws InterruptedException {
        ...
        switch(step) {
            ...
            case 5: //look at color
                ...
                else if (getTimer().targetReached(0.5))
                {
                    currentJewelPosition = shoulder.getPosition();
                    desiredJewelShoulderPosition -= SHOULDER_MOVEMENT_INCREMENT;
                    elbow.setPosition(desiredJewelElbowPosition);
                }
